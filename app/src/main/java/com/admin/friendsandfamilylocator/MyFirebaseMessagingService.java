...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void displaycustomnotification(final Uri myuri, final String extratitle, final String extramessage)
    {
        ...
        notificationManager.notify(21, n);

    }

    public void displaySimpleNotificationWhenGUIOpen(final String mytitle, final String mybody)
    {
        String CHANNEL_ID=  "CHANNEL_VMM";
